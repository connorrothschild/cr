...
undo_cr_theme <- function() {
  ...
  print("All CR defaults were removed and the cr package has been effectively detached from the current environment. To restore CR defaults, use set_cr_theme().")
